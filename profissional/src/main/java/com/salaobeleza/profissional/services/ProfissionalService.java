package com.salaobeleza.profissional.services;
...
import com.salaobeleza.profissional.mapper.ProfissionalMapper;
import com.salaobeleza.profissional.repositories.ProfissionalRepository;
import com.salaobeleza.profissional.exceptions.ResourceNotFoundException;
...
public class ProfissionalService {
    ...
    private void mergeProfissional(Profissional profissional, ProfissionalRequest request) {
        ...
        if(StringUtils.isNotBlank(request.getServicoId())) {
            var servico = apiServico.getServico(request.getServicoId());
    ...
    @Transactional
    public void excluiProfissional(String id) {
